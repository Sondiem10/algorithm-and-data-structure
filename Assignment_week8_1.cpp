...
int main() {
    ListSV list;
    SinhVien sv1 = {1, "Nguyen Van An", 1, {1, 1, 2004}, "Ha Noi", "K67ETE9", "DTVT"};
    SinhVien sv2 = {2, "Pham Hoang Son", 1, {1, 1, 2004}, "Ha Long","K67ETE9", "DTVT"};
    SinhVien sv3 = {3, "Pham Hoang ", 1, {1, 2, 2004}, "Ha Long","K67ETE9", "DTVT"};
    List_Add(&list, sv1);
    List_Add(&list, sv2);
    List_Add(&list, sv3);
    BubbleSort(&list);
    PrintList(&list);
    PrintSameBirthday(&list);
    RemoveSameBirthday(&list);
    PrintList(&list);
    return 0;
}
